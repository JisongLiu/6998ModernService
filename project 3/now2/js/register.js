...
var SLACK_URL = 'https://fqa9vsks99.execute-api.us-east-1.amazonaws.com/production/snstoslack';
              ...
              if (validate() == true) {
                $.ajax({
                    ...
                    success: function(data){
                      ...
                      var sendMessage = $('#username').val() + " registered his account";
                      ...
                      if (data == true) {
                        ...
                        //Then notify the slack
                        $.ajax({
                            type: "POST",
                            url: SLACK_URL,
                            data: JSON.stringify({"subject":subject,"message":sendMessage}),
                             success: function(data){
